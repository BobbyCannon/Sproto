...
namespace OSC.Tests.OSC
{
	...
	public class OscBundleTests
	{
		...
		public void ParseBundle()
		{
			...
			var expected = new OscBundle(time, new OscMessage(OscTimeTag.UtcNow, "/message", 123, "foo", true, null), new OscMessage(OscTimeTag.UtcNow, "/delay", 321));
			...
			var actual = OscPacket.GetPacket(data);
		...
		{
			var time = new OscTimeTag(new DateTime(2019, 1, 20, 08, 50, 12, DateTimeKind.Local));
			var expected = new OscBundle(time.Value, new OscMessage(OscTimeTag.UtcNow, "/message", 123, "bar", true, null), new OscMessage(OscTimeTag.UtcNow, "/delay", 321)) { IsExtended = true };
		...
		public void ParseExtendedBundleShouldFailCrcCheck()
		{
			...
			var error = (OscError) OscPacket.GetPacket(data);
			randomOffset.Dump();
			randomBit.Dump();
			data[randomOffset].ToString("X2").Dump();
		...
		{
			var time = new OscTimeTag(new DateTime(2019, 1, 20, 08, 50, 12, DateTimeKind.Local));
			var bundle = new OscBundle(time.Value, new OscMessage(OscTimeTag.UtcNow, "/message", 123, "foo", true, null), new OscMessage(OscTimeTag.UtcNow, "/delay", 321));
		...
		{
			var time = new OscTimeTag(new DateTime(2019, 1, 20, 08, 50, 12, DateTimeKind.Local));
			var bundle = new OscBundle(time.Value, new OscMessage(OscTimeTag.UtcNow, "/message", 123, "bar", true, null), new OscMessage(OscTimeTag.UtcNow, "/delay", 321)) { IsExtended = true };
